...
class Program
{
    ...
    {
         Address address1 = new Address("Ediene-Ikot Obioimoh", "Uyo", "Akwa-Ibom State", "Nigeria");
        Customer customer1 = new Customer("Bassey, Emmanuel", address1);
        Product product1 = new Product("Women Jewelry Set", "WO34KH4", 22.4, 4);
        Product product2 = new Product("Men's Jewelry Set", "ME34J8n", 28.4, 2);
        Product product3 = new Product("Children Jewelry Set", "CH34KD4", 15.4, 3);
        ...
        Address address2 = new Address("Esin", "Calabar", "Cross River State", "Nigeria");
        Customer customer2 = new Customer("Bassey, Emmanuel", address2);
        Product product4 = new Product("Women Jewelry Set", "WO34KH4", 22.4, 4);
        Product product5 = new Product("Men's Jewelry Set", "ME34J8n", 28.4, 2);
        Product product6 = new Product("Children Jewelry Set", "CH34KD4", 15.4, 3);
